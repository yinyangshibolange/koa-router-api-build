                ...
                if (stat.isFile() && this.apiExt.includes(path_1.default.parse(filepath).ext.replace(/^\./, ''))) {
                    ...
                    if (Array.isArray(indexDataDefault)) {
                        indexDataDefault.forEach(handler => {
                            this.apis.push(Object.assign({ import: (dir ? (dir + '/') : '') + files[k], importType: 'array', index: (this.base ? ('/' + this.base) : '') + `/` + (dir ? (dir + '/') : '') + path_1.default.parse(files[k]).name, method: handler.method || "get", handler: handler.handler || function (ctx) { } }, handler));
                        });
                    }
                    else if (typeof indexDataDefault === 'object') {
                        this.apis.push(Object.assign({ import: (dir ? (dir + '/') : '') + files[k], importType: 'object', index: (this.base ? ('/' + this.base) : '') + `/` + (dir ? (dir + '/') : '') + path_1.default.parse(files[k]).name, method: indexDataDefault.method || "get", handler: indexDataDefault.handler || function (ctx) { } }, indexDataDefault));
                    }
                    else if (typeof indexDataDefault === 'function') {
                        this.apis.push({
                            import: (dir ? (dir + '/') : '') + files[k],
                            importType: 'function',
                            index: (this.base ? ('/' + this.base) : '') + `/` + (dir ? (dir + '/') : '') + path_1.default.parse(files[k]).name,
                            method: "get",
                            handler: indexDataDefault || function (ctx) { },
                        });
                    }
                    else if (!indexDataDefault && indexData.handler) {
                        this.apis.push(Object.assign({ import: (dir ? (dir + '/') : '') + files[k], importType: '{method, handler}', index: (this.base ? ('/' + this.base) : '') + `/` + (dir ? (dir + '/') : '') + path_1.default.parse(files[k]).name, method: indexData.method || "get", handler: indexData.handler || function (ctx) { } }, indexData));
                    }
                }
